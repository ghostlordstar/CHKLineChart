...
#import "KlineInfo.h"
#import "CHKLineChartKit_Demo_ObjC-Swift.h"
...
- (void)fetchRemoteData
{
    ...
    [sessionManager GET:urlString parameters:@{} headers:nil progress:^(NSProgress * _Nonnull downloadProgress) {} success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
